@echo off
REM ============================================================================
REM Local Video Generation Service - Automated Setup (Python 3.11)
REM ============================================================================
REM This version uses py -3.11 launcher to target Python 3.11 specifically
REM ============================================================================
...
REM Check if py launcher with 3.11 is available
%PYTHON_CMD% --version >nul 2>&1
IF ERRORLEVEL 1 (
    echo [ERROR] Python 3.11 not found via py launcher
    echo.
    echo Please install Python 3.11+ from https://www.python.org/downloads/
    echo Make sure to check "Add Python to PATH" and "py launcher" during installation
    echo.
    echo After installation, run: py -3.11 --version
    echo.
    pause
    exit /b 1
)
